...
const scrollProgressBar = document.querySelector<HTMLElement>(
...
const setMenuVisibility = (expanded: boolean) => {
...
const updateMotionPreference = (isReduced: boolean) => {
...
const handleParallaxChange = (event: MediaQueryListEvent) => {
...
const renderHome = (root: HTMLElement) => {
...
const renderAbout = (root: HTMLElement) => {
...
const renderFeatures = (root: HTMLElement) => {
  const section = document.createElement("section");
...
const createLimitsList = (limits: LimitRecord) => {
...
const renderPricing = (root: HTMLElement) => {
  ...
  const renderCards = () => {
    ...
    plans.forEach((plan) => {
      ...
      if (plan.limits) {
        article.append(createLimitsList(plan.limits as LimitRecord));
      }
...
const renderFAQ = (root: HTMLElement) => {
  const section = document.createElement("section");
...
const renderBlog = (root: HTMLElement) => {
  const section = document.createElement("section");
...
const renderContact = (root: HTMLElement) => {
  const section = document.createElement("section");
  ...
  const formWrapper = section.querySelector<HTMLElement>(".contact-grid");
