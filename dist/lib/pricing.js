...
export function applyLaunchDiscount(base) {
    if (base == null)
        return null;
...
export function estMonthlyAICostPerSeat(limitGenerations) {
    const { aiTokenCostPer1k, avgTokensPerGeneration, utilizationFactor } = COST_ASSUMPTIONS;
